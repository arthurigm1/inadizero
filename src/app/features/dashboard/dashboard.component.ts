              ...
              <div class="bg-white border border-blue-200 rounded-xl p-6 hover:border-blue-400 transition-all duration-300 transform hover:scale-105" [@cardHover]>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-2">R$ 125.430</p>
              ...
              <div class="bg-white border border-blue-200 rounded-xl p-6 hover:border-blue-400 transition-all duration-300 transform hover:scale-105" [@cardHover]>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-2">247</p>
              ...
              <div class="bg-white border border-blue-200 rounded-xl p-6 hover:border-blue-400 transition-all duration-300 transform hover:scale-105" [@cardHover]>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-2">189</p>
              ...
              <div class="bg-white border border-blue-200 rounded-xl p-6 hover:border-blue-400 transition-all duration-300 transform hover:scale-105" [@cardHover]>
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-blue-900 mt-2">23</p>
            ...
            <div class="bg-white border border-blue-200 rounded-xl p-6">
              ...
              <div class="space-y-4">
                <div class="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div class="flex-1">
                    <p class="text-blue-900 font-medium">Pagamento recebido</p>
                    <p class="text-gray-600 text-sm">João Silva - Loja 15A - R$ 2.500,00</p>
                  </div>
                  <span class="text-gray-500 text-sm">2 min atrás</span>
                </div>
                ...
                <div class="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div class="flex-1">
                    <p class="text-blue-900 font-medium">Novo inquilino cadastrado</p>
                    <p class="text-gray-600 text-sm">Maria Santos - Loja 23B</p>
                  </div>
                  <span class="text-gray-500 text-sm">15 min atrás</span>
                </div>
                ...
                <div class="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <div class="flex-1">
                    <p class="text-blue-900 font-medium">Manutenção solicitada</p>
                    <p class="text-gray-600 text-sm">Loja 8C - Problema elétrico</p>
                  </div>
                  <span class="text-gray-500 text-sm">1 hora atrás</span>
                </div>
              </div>
            </div>
          </div>
