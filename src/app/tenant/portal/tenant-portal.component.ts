        ...
        <div class="flex items-center space-x-1 sm:space-x-3">
          ...
          <div class="relative">
            ...
            <div class="fixed inset-0 z-50 bg-white sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-2 sm:w-56 max-w-none sm:max-w-[92vw] rounded-none sm:rounded-xl shadow-lg border-0 sm:border border-blue-100 py-2"
              ...
              <div class="py-1">
                <a (click)="goToProfile()" class="flex items-center space-x-3 px-4 py-3 text-sm text-blue-700 hover:bg-blue-50 transition-colors border-b border-blue-50 cursor-pointer">
                  <svg class="w-5 h-5 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                  </svg>
                  <span>Meu Perfil</span>
                </a>
                <a (click)="goToSettings()" class="flex items-center space-x-3 px-4 py-3 text-sm text-blue-700 hover:bg-blue-50 transition-colors border-b border-blue-50 cursor-pointer">
                  <svg class="w-5 h-5 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export class TenantPortalComponent implements OnInit, OnDestroy {
  ...
  // Atalhos do menu de perfil
  goToProfile() {
    this.navigateToSection('configuracoes');
    this.profileMenuOpen = false;
  }
